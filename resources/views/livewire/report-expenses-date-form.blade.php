<form action="{{ route('reports.expenses') }}" enctype="multipart/form-data" method="post">
    <div class="pb-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="shadow bg-gray-400 md:rounded-md h-full">
                <div class="bg-gray-200 text-gray-700 text-lg px-6 py-4">
                    <h2 class="text-2xl font-bold mb-2">{{ trans_choice('tags.report', 1) }} {{ trans_choice('tags.expense', 2) }}
