<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('admin.expense.list') }}" class="text-sm text-gray-700 underline">{{ __('tags.return') }}</a>
        </div>
    </x-slot>
                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                                <h2 class="leading-relaxed">{{ __('tags.create')." ".trans_choice('tags.expense',2) }}</h2>
                                <p class="text-sm text-gray-500 font-normal leading-relaxed">
                                    {{ __('Crear un nuevo gasto para la aplicación') }}</p>
                            </div>
                        </div>
